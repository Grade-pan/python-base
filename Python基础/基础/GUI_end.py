...
# 第2步，给窗口的可视化起名字
window.title('Welcome to PXY Website')
...
image_file = tk.PhotoImage(file='E:\\tim.gif')
image = canvas.create_image(200, 0, anchor='n', image=image_file)
canvas.pack(side='top')
tk.Label(window, text='Welcome', font=('Arial', 16), fg='green').pack()
...
def usr_sign_up():
    ...
    btn_confirm_sign_up = tk.Button(window_sign_up, text='Sign up', command=sign_to_Hongwei_Website)
